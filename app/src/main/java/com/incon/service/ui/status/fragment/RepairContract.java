...
public interface RepairContract {
    ...
    interface View extends BaseView {
        void loadingRepairServiceRequests(List<FetchNewRequestResponse> fetchNewRequestResponses);
    ...
    interface Presenter {
        void fetchRepairServiceRequests(int servicerCenterId, int userId);
