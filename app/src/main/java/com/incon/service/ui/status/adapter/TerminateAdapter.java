...
import com.incon.service.databinding.ItemTerminateFragmentBinding;
...
public class TerminateAdapter  extends BaseRecyclerViewAdapter {
    private AddressFromLatLngAddress addressFromLatLngAddress;
    private ConnectApplication context;

    public TerminateAdapter() {
        addressFromLatLngAddress = new AddressFromLatLngAddress();
        context = ConnectApplication.getAppContext();
    }

    @Override
    public TerminateAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        ItemTerminateFragmentBinding binding = DataBindingUtil.inflate(layoutInflater,
                R.layout.item_terminate_fragment, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((TerminateAdapter.ViewHolder) holder).bind(fetchNewRequestResponse);
    }

    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private final ItemTerminateFragmentBinding binding;

        public ViewHolder(ItemTerminateFragmentBinding binding) {
